...
export default function Navbar({
  ...
  // ============================================================
  // IST CLOCK
  // Dashboard displays India Standard Time.
  // Forensic timestamps from Sentinel/backend remain in UTC.
  // ============================================================
  useEffect(() => {
    const updateTime = () => {
      const now = new Date();
  ...
  return (
    ...
    >
      {/* ========================================================
          LEFT: CORPORATE BRAND & ENVIRONMENT INFORMATION
          ======================================================== */}
          ...
          >
            <span>
              ...
              <strong
                ...
                className="mono"
              >
                {azureStatus?.subscription_id
                  ? `${azureStatus.subscription_id.slice(0, 13)}...`
                  : 'Demo-Subscription'}
              </strong>
            </span>
